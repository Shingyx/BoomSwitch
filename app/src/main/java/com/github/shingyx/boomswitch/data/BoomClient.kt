...
private class BoomClientInternal(
  ...
  /**
   * Initiates connecting to the speaker's Gatt server. Called by entry function [switchPower] and
   * continued by [onConnectionStateChange].
   */
  ...
  /**
   * Scans for the available Gatt services and characteristics. Called by [onConnectionStateChange]
   * and continued by [onServicesDiscovered].
   */
  ...
  /**
   * Reads the speaker's current state. Called by [onServicesDiscovered] and continued by
  ...
  /**
   * Writes the new power state for the speaker to toggle it on or off. Called by
   * [onCharacteristicRead] and continued by [onCharacteristicWrite].
   */
  ...
  /**
   * Closes the Gatt connection with the speaker. Called by [onCharacteristicWrite] and continued by
